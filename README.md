# Vini Amaral — Portfolio de Engenharia de Software

Este é o portfolio profissional de **Vini Amaral**, um Engenheiro de Software Sênior especializado em sistemas escaláveis, arquitetura de nuvem e integração de Inteligência Artificial. O design foi inspirado na estética moderna e técnica do ecossistema Google Firebase.

## 🚀 Tecnologias Utilizadas

O projeto foi construído com as tecnologias mais modernas do mercado para garantir performance, SEO e uma experiência de usuário premium:
...
1. **Clone o repositório:**
   ```bash
   git clone https://github.com/Tech-Lab-ai/portfolio.git
   ```
