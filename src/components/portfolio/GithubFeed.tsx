...
import { GitBranch, Loader2, Zap, AlertCircle } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <Badge variant="outline" className="px-4 py-1 text-primary border-primary/20">
              <Zap className="w-3 h-3 mr-2 fill-primary" /> Roadmap de Engenharia
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold">Status do CloudForge CLI</h2>
            <p className="text-muted-foreground">
              Acompanhamento em tempo real das issues e tarefas do meu projeto principal, processado por IA.
            </p>
          </div>
            ...
            <CardContent>
              {loading ? (
                <div className="flex flex-col items-center justify-center py-12 gap-4 text-muted-foreground">
                  ...
                  <p className="animate-pulse">Analisando progresso via IA...</p>
                </div>
              ) : (
